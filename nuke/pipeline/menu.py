...
n.addCommand("Build DI Matte Pass", "send_for_review(cc=False, b_method_avidqt=False, b_method_vfxqt=False, b_method_burnin=False, b_method_hires=False, b_method_matte=True)")
