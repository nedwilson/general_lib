...
def init_shot_env():
    ...
    try:
        ...
        nuke.addFavoriteDir("SHOT/nuke", os.path.join(l_nukescript_dir))
        nuke.addFavoriteDir("SHOT/plates", os.path.join(l_plate_dir))
        nuke.addFavoriteDir("SHOT/precomp", os.path.join(l_precomp_dir))
        nuke.addFavoriteDir("SHOT/comp", os.path.join(l_rendercomp_dir))
        nuke.addFavoriteDir("SHOT/elements", os.path.join(l_element_dir))
        nuke.addFavoriteDir("SHOT/renders", os.path.join(l_renderelem_dir))
        nuke.addFavoriteDir("SHOT/mograph", os.path.join(l_mograph_dir))
